  ...
  _createClass(GridItem, [{
    ...
    /*: ReactNode*/
    {
      ...
      if (this.props.absoluteLayout == true) {
        //absoluteStyle.zIndex = '300', absoluteStyle.border = '3px solid red';
      }
      ...
      var newChild = /*#__PURE__*/_react.default.cloneElement(child, {
        ...
        style: _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, absoluteStyle), this.props.style), child.props.style), this.createStyle(pos))
