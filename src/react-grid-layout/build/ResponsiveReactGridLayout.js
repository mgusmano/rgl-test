...
var ResponsiveReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  /*: void*/
  {
    ...
    _this = _super.call(this, props, context); //console.log(props)
  ...
  _createClass(ResponsiveReactGridLayout, [{
    ...
    /*: State*/
    {
      ...
      var initialLayout = (0, _responsiveUtils.findOrGenerateResponsiveLayout)(layouts, breakpoints, breakpoint, breakpoint, colNo, compactType); //console.log('b',initialLayout)
