...
var ReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  /*: void*/
  {
   ...
   // _classCallCheck(_this, ReactGridLayout);
    ...
    console.log('mjg5'); //console.log(this.props.layout)
  ...
  _createClass(ReactGridLayout, [{
    ...
    , _ref2) {
      ...
      console.log('in onDrag', l.absoluteLayout); // Create placeholder (display only)
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var bounded = draggable && isBounded && l.isBounded !== false; //console.log(l)
...
}(_react.default.Component); //        {this.placeholder()}
